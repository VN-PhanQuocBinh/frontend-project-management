export const mockData = {
  project: {
    ...
    description: 'This is a project management application project used to track tasks and progress.',
    type: 'public', // 'private'
    ownerIds: [], // Những users là Admin của project
    memberIds: [], // Những users là member bình thường của project
    columnOrderIds: ['column-id-01', 'column-id-02', 'column-id-03', 'column-id-04'], // Thứ tự sắp xếp / vị trí của các Columns trong 1 projects
    boardColumns: [
      {
        id: 'column-id-01',
        projectId: 'project-id-01',
        title: 'To Do Column 01',
        taskOrderIds: ['card-id-01', 'card-id-02', 'card-id-03', 'card-id-04', 'card-id-05', 'card-id-06', 'card-id-07'],
        tasks: [
          {
            id: 'card-id-01',
            projectId: 'project-id-01',
      ...
      },
      {
        ...
        taskOrderIds: ['column-id-04-placeholder-card'],
        tasks: [
          {
